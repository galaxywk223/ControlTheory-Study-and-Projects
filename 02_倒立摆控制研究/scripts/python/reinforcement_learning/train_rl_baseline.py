...
RUN_DIR = PROJECT_ROOT / "runs" / "reinforcement_learning" / "baseline"
TRAINING_FIGURE = (
    PROJECT_ROOT
    / "assets"
    / "figures"
...
def plot_simulation_results(t: np.ndarray, states: np.ndarray, out_path: str):
...
if __name__ == "__main__":
    ...
    # ----- Plot training curve -----
    print("\n--- Plot training curve ---")
    plot_training_results(log_folder, str(TRAINING_FIGURE))
    ...
    plot_simulation_results(sim_time, states_history, str(SIMULATION_FIGURE))
